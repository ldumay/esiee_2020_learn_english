...
--
-- Structure de la table `sound_and_mots`
--

CREATE TABLE `sound_and_mots` (
  `id` int(64) NOT NULL,
...
--
-- Déchargement des données de la table `sound_and_mots`
--

INSERT INTO `sound_and_mots` (`id`, `id_sound`, `id_mots`, `date_create`, `date_update`) VALUES
(1, 5, 1, NULL, NULL),
(2, 6, 2, NULL, NULL),
(3, 7, 3, NULL, NULL),
(4, 8, 4, NULL, NULL);
...
--
-- Structure de la table `def_and_mots`
--

CREATE TABLE `def_and_mots` (
  `id` int(64) NOT NULL,
  `id_mots` int(64) NOT NULL,
...
--
-- Déchargement des données de la table `def_and_mots`
--

INSERT INTO `def_and_mots` (`id`, `id_mots`, `id_def`, `date_create`, `date_update`) VALUES
(9, 1, 1, NULL, NULL),
(10, 2, 2, NULL, NULL),
(11, 3, 3, NULL, NULL),
(12, 4, 4, NULL, NULL);
...
--
-- Déchargement des données de la table `sound_and_images`
--

INSERT INTO `sound_and_images` (`id`, `id_sound`, `id_images`, `date_create`, `date_update`) VALUES
(1, 1, 1, NULL, NULL),
(2, 2, 2, NULL, NULL),
(3, 3, 3, NULL, NULL),
(4, 4, 4, NULL, NULL);
...
--
-- Index pour la table `sound_and_def`
--
ALTER TABLE `sound_and_images`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sound_and_mots`
--
ALTER TABLE `sound_and_mots`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_sound` (`id_sound`),
  ADD KEY `id_mots` (`id_mots`);

--
-- Index pour la table `def_and_mots`
--
ALTER TABLE `def_and_mots`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `def`
--
ALTER TABLE `def`
  MODIFY `id` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT pour la table `sound_and_def`
--
ALTER TABLE `sound_and_images`
  MODIFY `id` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT pour la table `sound_and_mots`
--
...
--
-- Contraintes pour la table `sound_and_mots`
--
ALTER TABLE `sound_and_mots`
  ADD CONSTRAINT `sound_and_mots_ibfk_1` FOREIGN KEY (`id_sound`) REFERENCES `sound` (`id`),
  ADD CONSTRAINT `sound_and_mots_ibfk_2` FOREIGN KEY (`id_mots`) REFERENCES `mots` (`id`);

--
-- Contraintes pour la table `sound_and_def`
--
ALTER TABLE `sound_and_images`
  ADD CONSTRAINT `sound_and_images_ibfk_1` FOREIGN KEY (`id_sound`) REFERENCES `sound` (`id`),
  ADD CONSTRAINT `sound_and_images_ibfk_2` FOREIGN KEY (`id_images`) REFERENCES `images` (`id`);



--
-- Contraintes pour la table `def_and_mots`
--
ALTER TABLE `def_and_mots`
  ADD  FOREIGN KEY (`id_def`) REFERENCES `def` (`id`),
  ADD  FOREIGN KEY (`id_mots`) REFERENCES `mots` (`id`);
