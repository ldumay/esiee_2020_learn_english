...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
    ...
    <head>
        ...
        <meta name="Description" content="<?php echo $project_metadatas_description; ?>">
        <meta name="Subject" content="<?php echo $project_metadatas_subject; ?>">
        <meta name="Copyright" content="<?php echo $project_metadatas_copyright; ?>">
        <meta name="Author" content="<?php echo $project_metadatas_author; ?>">
        <meta name="Publisher" content="<?php echo $project_metadatas_publisher; ?>">
        <meta name="Identifier-Url" content="<?php echo $project_metadatas_identifier_url; ?>">
        <meta name="Reply-To" content="<?php echo $project_metadatas_replyto; ?>">
        <meta name="Revisit-After" content="<?php echo $project_metadatas_revisit_after; ?>">
        <meta name="Robots" content="<?php echo $project_metadatas_index; ?>">
        <meta name="Rating" content="<?php echo $project_metadatas_rating; ?>">
        <meta name="Distribution" content="<?php echo $project_metadatas_distribution; ?>">
        <meta name="Geography" content="<?php echo $project_metadatas_geography; ?>">
        <meta name="Category" content="<?php echo $project_metadatas_category; ?>">
        <!-- ./MetasDatas -->
